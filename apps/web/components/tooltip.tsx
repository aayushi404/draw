"use client"
export default function Tooltip({updateTool}:{updateTool:(tool:string) => void}){
    return(
        <div className="fab fab-flower">
            ...
            <button className="btn btn-circle btn-lg" aria-label="circle" onClick={() => updateTool("circle")}>
                <svg
            ...
            <button className="btn btn-circle btn-lg" aria-label="rect" onClick={() => updateTool("rect")}>
                <svg
                aria-label="New poll"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
            ...
            <button className="btn btn-circle btn-lg" aria-label="RegularPolygon" onClick={() => updateTool("RegularPolygon")}>
                <svg
